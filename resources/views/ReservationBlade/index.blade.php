...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card mt-3">
          <div class="card-body">
            <h3 class="font-weight-bold">Reservation Listing</h3> <br>
            <a href="{{ route('reservations.showTrip') }}">
                <button class="btn btn-success">Add New Reservation</button>
            </a>
            <a href="" class="me-0 float-right">
                <button class="btn btn-primary">Add new large trip Reservation</button>
            </a>
            <br>
            <form action="">
            {{-- <div class="row mt-2">
                ...
                <div class="col-md-6  offset-md-10 mt-md-0 mt-2">
                    <div class="data">
                        <p class="font-weight-bold mb-0">Completed</p><span></span>
                        <p class="font-weight-bold mb-0">Total reservations</p><span></span>
                        <p class="font-weight-bold">Total Guides</p><span></span>
                    </div>
                </div>
            </div> --}}
            </form>
                  ...
                  <div class="card">
                    <div class="card-header p-2">
                      <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#new" data-toggle="tab">New  Reservation</a></li>
                      </ul>
                    </div><!-- /.card-header -->
                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane" id="new">
                            <table class="table">
                                ...
                                <tbody>
                                  @foreach ($reservations as $reservation)
                                  @if ($reservation->date >= now()->format('m/d/Y')&& $reservation->created_by=='Frontend')
                                  <tr class="text-center">
                                      <td>{{ $reservation->fname }} {{ $reservation->lname }}</td>
                                      <td>{{ date('m/d/Y H:i:s', strtotime($reservation->created_at)) }}</td>
                                      <td>{{ $reservation->date }}</td>
